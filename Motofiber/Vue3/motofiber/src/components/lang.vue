<template>
  <div class="relative">
    ...
    >
       <span :class= '$t("class_picturre")'></span>
    ...
    <transition name="dropdown-fade">
      <ul v-on-clickaway="hideDropdown" v-if="isVisible" ref="dropdown" class="absolute normal-case z-30 font-normal xs:left-0 lg:right-0 bg-white shadow overflow-hidden rounded w-48 border py-1 lg:z-20">
        <li>
          <a href="#"
        ...
        <li>
          <a href="#" @click.prevent="setLocale('bg')"
            class="flex items-center px-3 py-3 hover:bg-gray-200"
